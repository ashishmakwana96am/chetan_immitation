...
class ModuleController extends Controller
{
    ...
    public function data()
    {
        ...
        $data = $modules->map(function ($module, $index) use ($canEdit, $canDelete) {
            ...
            $actions = '';
            if ($canEdit) {
                $actions .= '<button class="btn btn-sm btn-icon btn-label-info me-1" data-common-modal="' . route('admin.modules.edit', $module) . '" data-bs-toggle="tooltip" title="Edit"><i class="ti ti-pencil"></i></button>';
            }
            if ($canDelete) {
                $actions .= '<button class="btn btn-sm btn-icon btn-label-danger" data-common-delete="' . route('admin.modules.destroy', $module) . '" data-row-id="module-row-' . $module->id . '" data-bs-toggle="tooltip" title="Delete"><i class="ti ti-trash"></i></button>';
            }
