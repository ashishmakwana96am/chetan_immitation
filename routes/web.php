...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth:web', 'active.user'])->group(function () {
        ...
        Route::get('purchases/{purchase}/impact-check', [PurchaseController::class, 'impactCheck'])->name('purchases.impact-check');
        ...
        Route::prefix('reports')->name('reports.')->group(function () {
            ...
            Route::get('payments/data', [ReportController::class, 'paymentsData'])->name('payments.data');
