...
@section('page-css')
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            #filterDropdownContainer .dropdown-menu.state-filter-dropdown {
            ...
            #filterDropdownContainer .dropdown-menu.state-filter-dropdown.show {
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h4 class="fw-semibold mb-0">States List</h4>
        <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <div class="dropdown d-inline-block" id="filterDropdownContainer">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg state-filter-dropdown" id="filterDropdownMenu">
            ...
            @can('create states')
                <button class="btn btn-primary" data-common-modal="{{ route('admin.states.create') }}"><i class="ti ti-plus me-1"></i> Add State</button>
            @endcan
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="table border-top" id="statesTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>State Name</th>
                        ...
                        <th>Delivery Days</th>
                        <th>Status</th>
                        @if(auth()->user()->can('edit states') || auth()->user()->can('delete states'))
                            <th>Actions</th>
                        @endif
                    </tr>
                </thead>
...
@section('page-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            function closeStateFilterSidepanel() {
                isForceClosing = true;
