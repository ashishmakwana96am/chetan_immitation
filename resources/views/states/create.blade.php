<div class="text-center mb-4">
    <h3 class="mb-2">Add New State</h3>
    <p class="text-muted">Fill in the details to create a new state</p>
</div>

<form id="commonModalForm" action="{{ route('admin.states.store') }}" method="POST" class="d-flex flex-column flex-grow-1">
    @csrf
    <div class="row g-3">
        <div class="col-12">
            <label class="form-label" for="stateName">State Name <span class="text-danger">*</span></label>
            <input type="text" id="stateName" name="name"
                class="form-control" placeholder="Enter State Name" autofocus />
        ...
        <div class="col-12">
            ...
            <div class="form-check form-switch mt-1">
                <input class="form-check-input" type="checkbox" id="stateStatus" name="status" value="1" checked />
    ...
    <div class="d-flex gap-2 mt-auto pt-3 border-top">
        <button type="submit" class="btn btn-primary w-50">Create State</button>
