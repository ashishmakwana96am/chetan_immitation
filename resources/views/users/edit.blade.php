...
<form id="commonModalForm" action="{{ route('admin.users.update', $user) }}" method="POST" class="d-flex flex-column flex-grow-1">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="email" id="userEmail" name="email" class="form-control" placeholder="Enter Email Address"
                value="{{ $user->email }}" />
            <div class="invalid-feedback"></div>
        </div>
        <div class="col-md-6">
            <label class="form-label" for="userPhone">Phone</label>
            <input type="text" id="userPhone" name="phone" class="form-control" placeholder="Enter Phone Number"
                value="{{ $user->phone }}" />
            <div class="invalid-feedback"></div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="form-check form-switch mt-2">
                <input class="form-check-input" type="checkbox" id="userStatus" name="status" value="1"
