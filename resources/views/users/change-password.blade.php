<div class="text-center mb-4">
    ...
    <p class="text-muted">Change password for user: <strong class="text-capitalize">{{ $user->name }}</strong></p>
</div>

<form id="commonModalForm" action="{{ route('admin.users.update-password', $user) }}" method="POST" class="d-flex flex-column flex-grow-1">
    @csrf
    <div class="row g-3 mb-4">
        <div class="col-12">
            <label class="form-label" for="password">New Password <span class="text-danger">*</span></label>
            <div class="input-group input-group-merge">
                <input type="password" id="password" name="password" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" autofocus required />
