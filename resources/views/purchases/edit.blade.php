                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="payment_method" id="paymentMethodSelect" class="form-select no-select2">
                                    <option value="cash"   {{ ($purchase->payment_method ?? 'cash') === 'cash'   ? 'selected' : '' }}>Cash</option>
                                    <option value="online" {{ ($purchase->payment_method ?? 'cash') === 'online' ? 'selected' : '' }}>Online</option>
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <select name="payment_status" id="paymentStatusSelect" class="form-select no-select2">
                            ...
                            <option value="3" {{ ($purchase->payment_status ?? 1) == 3 ? 'selected' : '' }}>Partially Paid</option>
                            <option value="2" {{ ($purchase->payment_status ?? 1) == 2 ? 'selected' : '' }}>Paid</option>
                        </select>
                        <div class="mt-3 {{ ($purchase->payment_status ?? 1) == 3 ? '' : 'd-none' }}" id="paidAmountWrapper">
                            <label class="form-label">Amount Paid (Total So Far)</label>
                            <input type="number" name="paid_amount" id="paidAmountInput" class="form-control" min="0.01" step="0.01" value="{{ $purchase->paid_amount ?? 0 }}" placeholder="Enter total amount paid so far" />
                        </div>
                    </div>
                </div>
            </div>
