        ...
        <div class="grid lg:grid-cols-2 gap-5 items-stretch">
            ...
            <div class="border border-[#D5D5D5] rounded-[8px] px-5 py-6 lg:py-[30px] lg:px-[30px]">
                ...
                <div class="text-center">
                    <h1 class="font-moglan text-[#131615] text-[38px] md:text-[48px] lg:text-[54px] leading-none">Create Your Account</h1>
                ...
                <form id="registerForm" class="mt-5 xl:mt-8" novalidate>
                    ...
                    <div class="mb-5">
                        <label for="name" class="block text-lg leading-[18px] font-medium text-[#131615] mb-[15px]">Full Name <span class="text-[#dc2626]">*</span></label>
                    ...
                    <div class="mb-5">
                        <label for="phone" class="block text-lg leading-[18px] font-medium text-[#131615] mb-[15px]">Mobile Number <span class="text-[#dc2626]">*</span></label>
                        <input id="phone" name="phone" type="tel" placeholder="Enter Your 10-digit Mobile Number" maxlength="10"
                            class="w-full h-[52px] border border-[#D5D5D5] px-4 text-lg text-[#757575] outline-none bg-white placeholder:text-lg rounded-sm transition-colors duration-200">
                        <p class="field-error hidden" id="phone-error"></p>
                    </div>

                    <div class="mb-5">
                        <label for="email" class="block text-lg leading-[18px] font-medium text-[#131615] mb-[15px]">Email Address <span class="text-[#dc2626]">*</span></label>
                    ...
                    <div class="mb-5">
                        <label for="password" class="block text-lg leading-[18px] font-medium text-[#131615] mb-[15px]">Password <span class="text-[#dc2626]">*</span></label>
                        <div class="pw-wrap">
                            <input id="password" name="password" type="password" placeholder="Enter Your Password"
                                class="w-full h-[52px] border border-[#D5D5D5] px-4 pr-11 text-lg text-[#757575] outline-none bg-white placeholder:text-lg rounded-sm transition-colors duration-200">
                    ...
                    <div class="mb-6">
                        <label for="password_confirmation" class="block text-lg leading-[18px] font-medium text-[#131615] mb-[15px]">Confirm Password <span class="text-[#dc2626]">*</span></label>
                        <div class="pw-wrap">
                    ...
                    <button type="submit" id="registerBtn"
                        class="w-full h-[52px] bg-[#B4771E] text-white text-lg font-medium hover:bg-[#131615] transition flex items-center justify-center gap-2 rounded-sm">
