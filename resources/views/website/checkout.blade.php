        ...
        <div class="container-1440">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,60%)_1fr] 2xl:grid-cols-[953px_1fr] lg:gap-6 items-start">
                ...
                <div class="min-w-0 space-y-6">
                    @if(session('warning'))
                    <div class="mb-6 flex items-start gap-3 bg-amber-50 border border-amber-200 rounded p-4 text-[#B4771E]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 mt-0.5 w-5 h-5 text-amber-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                        </svg>
                        <div>
                            <p class="font-semibold text-sm">Cart Adjusted</p>
                            <p class="text-xs sm:text-sm mt-1">{{ session('warning') }}</p>
                        </div>
                    </div>
                    @endif
                    <!-- =====================
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-[1fr_auto] gap-2">
                            ...
                            <button id="couponActionBtn" onclick="handleCouponAction()"
                                class="bg-[#B4771E] text-white px-4 h-[44px] lg:h-[52px] whitespace-nowrap text-base transition rounded-sm w-full xl:w-auto">
