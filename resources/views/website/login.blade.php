    ...
    <div class="container-1440">
        <div class="grid lg:grid-cols-2 gap-6 items-stretch mx-auto">
            ...
            <div class="border border-[#D5D5D5] px-5 py-6 lg:py-10 lg:px-[30px] rounded-[4px]">
                ...
                @if(session('error'))
                    <div class="mt-5 flex items-start gap-3 bg-[#fef2f2] border border-[#f87171] rounded-[6px] px-4 py-3">
                        <svg class="shrink-0 mt-[2px] w-5 h-5 text-[#dc2626]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                        <p class="text-[#991b1b] text-base leading-snug">
                            {{ session('error') }}
                        </p>
                    </div>
                @endif
                ...
                <form id="loginForm" class="mt-5 xl:mt-10" novalidate>
                    ...
                    <button type="submit" id="loginBtn"
                        class="w-full h-[52px] bg-[#B4771E] text-white mt-6 text-lg font-medium hover:bg-[#131615] transition flex items-center justify-center gap-2 rounded-sm">
