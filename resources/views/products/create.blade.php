        ...
        $(document).ready(function () {
            ...
            $('#productCodeInput').on('input change', function () {
                ...
                if (isPair) {
                    ...
                    const pairMrp = roundToNearest5(pairSalePrice * 1.10).toFixed(2);
                    const singleSalePrice = roundToNearest5(pairSalePrice / 2).toFixed(2);
                    const singleMrp = roundToNearest5(singleSalePrice * 1.10).toFixed(2);
                    ...
                    const mrp = roundToNearest5(salePrice * 1.10).toFixed(2);
            ...
            $('#salePriceInput').on('input', function () {
                $('#mrpInput').val(roundToNearest5((parseFloat($(this).val()) || 0) * 1.10).toFixed(2));
            });

            $('#pairSalePriceInput').on('input', function () {
                $('#pairMrpInput').val(roundToNearest5((parseFloat($(this).val()) || 0) * 1.10).toFixed(2));
            });
