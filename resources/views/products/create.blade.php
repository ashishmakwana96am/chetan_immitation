                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="productHideFromWebsite" name="hide_from_website" value="1" {{ !isset($clonedProduct) || $clonedProduct->hide_from_website ? 'checked' : '' }} />
                            <label class="form-check-label" for="productHideFromWebsite">Hide From Website</label>
                        </div>
                    </div>
                </div>
...
@section('page-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            let customSizesList = @json(isset($clonedProduct) && $clonedProduct->custom_sizes ? collect($clonedProduct->custom_sizes)->pluck('size')->map(fn($s) => (int) $s)->sort()->values() : []);
