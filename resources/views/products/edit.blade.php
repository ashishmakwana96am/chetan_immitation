                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    @if($product->barcode)
                                    <button type="button" onclick="viewBarcode('{{ $product->barcode }}', {{ $product->id }}, '{{ addslashes($product->sku) }}', '{{ addslashes($product->product_code) }}', '{{ addslashes($product->name) }}', '{{ addslashes(format_price($product->mrp)) }}')" class="btn btn-icon btn-label-secondary" title="View Barcode">
