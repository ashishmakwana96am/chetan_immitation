...
<head>
    ...
    @if(str_contains(request()->fullUrl(), '/staging') || config('app.env') === 'staging')
    ...
    <footer class="bg-[#131615]">
        <div class="container-1440">
            <div class="grid {{ (isset($sharedCategories) && count($sharedCategories) > 0) ? 'lg:grid-cols-[1.5fr_1fr_1.2fr_1.8fr]' : 'lg:grid-cols-[1.5fr_1.2fr_1.8fr]' }} md:grid-cols-2 gap-3 sm:gap-5 lg:gap-9 py-5 sm:py-10">
                ...
                @if(isset($sharedCategories) && count($sharedCategories) > 0)
                <div>
                    <h3 class="text-[#B4771E] text-base sm:text-[18px] lg:text-lg font-semibold mb-3 sm:mb-5">Shop By Categories</h3>
...
window.addEventListener('resize', function () {
    ...
    <div id="deleteConfirmModal" class="fixed inset-0 z-[9999] hidden bg-black/50 p-4 !mt-0 overflow-y-auto">
