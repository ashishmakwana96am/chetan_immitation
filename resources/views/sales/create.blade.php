                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch">
                                            <input 
                                                ...
                                                value="1"
                                            />
                                            <label class="form-check-label" for="is_gst_switch">
                                                GST Bill
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch mb-0">
                                            <input 
                                                class="form-check-input" 
                                                type="checkbox" 
                                                id="is_shipping_switch" 
                                                name="is_shipping" 
                                                value="1"
                                            />
                                            <label class="form-check-label" for="is_shipping_switch">
                                                Shipping
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="input-group input-group-sm" style="max-width: 170px;">
                                        ...
                                        <input type="number" id="summaryFinalInput" class="form-control text-end fw-bold text-primary fs-5 py-1 px-2" value="0" min="0" step="0.01" placeholder="0.00" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2 mt-1" id="paymentSplitWrapper">
                            <div class="col-6">
                                ...
                                <input type="number" name="paid_cash_amount" id="paidCashAmountInput" class="form-control" value="0" min="0" step="0.01">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-6">
                                <label class="form-label">Online</label>
                                <input type="number" name="paid_online_amount" id="paidOnlineAmountInput" class="form-control" value="0" min="0" step="0.01">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    function getMinAllowedTotal(row) {
        ...
        if (product && product.pair_product) {
            ...
            if (effectiveSizes && effectiveSizes.length) {
                // If custom sizes exist with explicit prices (sale_price/mrp), purchase price for 1 pcs vs 2 pcs or pack should not multiply by size ratio
                if (!isPair) {
    ...
    function getSelectedShippingState() {
        if (!$('#is_shipping_switch').is(':checked')) return '';
