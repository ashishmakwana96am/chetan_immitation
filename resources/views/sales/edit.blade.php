                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 d-none" id="summaryShippingRow">
                                    ...
                                    <div class="input-group input-group-sm" style="max-width: 170px;">
                                        ...
                                        <input type="number" id="summaryShippingInput" name="shipping_charge" class="form-control text-end fw-bold text-primary fs-5 py-1 px-2" value="{{ (float)$order->shipping_charge > 0 ? number_format((float)$order->shipping_charge, 2, '.', '') : '' }}" min="0" step="0.01" placeholder="0.00" />
                                    </div>
                                </div>
                                <hr />
...
$(document).ready(function () {
    ...
    function addItemRow(product, selectedVariantId = null, qty = 1, price = null, discountType = 'percentage', discountValue = 0, pairType = 'single', customSizeValue = null, prependRow = true, existingMrp = null, purchaseItemId = null, existingPurchasePrice = null, orderItemId = null) {
        ...
        updateRowTotal(row);
        updateStockInfo(row);
        loadProductBatches(row, purchaseItemId, prependRow);
