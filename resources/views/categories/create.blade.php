        ...
        <div class="col-12">
            ...
            <div class="mt-3 d-none" id="croppedPreviewContainer">
                <div class="position-relative d-inline-block">
                    <img id="croppedPreview" src="" class="img-thumbnail object-fit-cover" style="width: 150px; height: 150px; border-radius: 8px;" />
...
$(document).ready(function () {
    ...
    $fileInput.on('change', function () {
        ...
        if (file.size > 5 * 1024 * 1024) {
            toastr.error('The image size must be less than 5 MB.');
            $base64Input.addClass('is-invalid');
            $base64Input.siblings('.invalid-feedback').text('The image size must be less than 5 MB.');
            this.value = '';
            $base64Input.val('');
