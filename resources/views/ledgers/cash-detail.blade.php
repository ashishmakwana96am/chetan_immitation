...
@section('title', 'Cash Ledger Details')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <h4 class="fw-semibold mb-0">Cash Ledger Details</h4>
        ...
        <div>
            <a href="{{ route('admin.ledgers.cash') }}" class="btn btn-label-secondary">
        ...
        <div class="col-lg-8 col-md-7">
            <div class="card">
                ...
                <div class="card-datatable table-responsive">
                    <table class="table border-top table-hover mb-0" id="cashTransactionsTable">
                        <thead>
                            <tr>
                                <th style="width: 5%">#</th>
                                <th>Time</th>
...
@section('page-js')
    ...
    <script>
        $(document).ready(function () {
            if ($('#cashTransactionsTable tbody tr').length > 0 && $('#cashTransactionsTable tbody tr td[colspan]').length === 0) {
