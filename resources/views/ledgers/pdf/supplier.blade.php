    ...
    <table class="summary-box">
        <tr>
            ...
            <td style="width: 33.33%;">
                ...
                <div class="summary-value">{{ format_price($totalPaid) }}</div>
            </td>
            <td style="width: 33.33%;">
                <div class="summary-label">Due Amount</div>
                <div class="summary-value">{{ format_price($totalDue) }}</div>
            </td>
        </tr>
    </table>
        ...
        <tbody>
            @forelse($rows as $index => $row)
                <tr>
                    ...
                    <td class="text-right text-danger fw-bold">{{ format_price($row['due_amount']) }}</td>
                </tr>
            @empty
                <tr>
