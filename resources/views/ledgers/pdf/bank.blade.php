    ...
    <table class="summary-box">
        <tr>
            <td style="width: 33.33%;">
                <div class="summary-label">Total Receipt (In)</div>
                <div class="summary-value">{{ format_price($totalIn) }}</div>
            </td>
            <td style="width: 33.33%;">
                <div class="summary-label">Total Payment (Out)</div>
                <div class="summary-value">{{ format_price($totalOut) }}</div>
            </td>
            <td style="width: 33.33%;">
                <div class="summary-label">Current Bank Balance</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 20%;" class="text-right">Receipt</th>
