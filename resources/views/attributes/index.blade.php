...
@section('page-css')
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            #filterDropdownContainer .dropdown-menu.attribute-filter-dropdown {
            ...
            #filterDropdownContainer .dropdown-menu.attribute-filter-dropdown.show {
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 align-items-center flex-wrap">
            ...
            <div class="dropdown d-inline-block" id="filterDropdownContainer">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg attribute-filter-dropdown" id="filterDropdownMenu">
...
@section('page-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            function closeAttributeFilterSidepanel() {
