<div class="text-center mb-4">
    <h3 class="mb-2">Add New Attribute</h3>
    <p class="text-muted">Fill in the details to create a new attribute</p>
</div>

<form id="commonModalForm" action="{{ route('admin.attributes.store') }}" method="POST" class="d-flex flex-column flex-grow-1">
    @csrf
    <div class="row g-3">
        <div class="col-12">
            ...
            <input type="text" id="attributeName" name="name"
                class="form-control" placeholder="e.g. Color, Size, Material" autofocus />
        ...
        <div class="col-12">
            ...
            <div class="form-check form-switch mt-1">
                <input class="form-check-input" type="checkbox" id="attributeStatus" name="status" value="active" checked />
    ...
    <div class="d-flex gap-2 mt-auto pt-3 border-top">
        <button type="submit" class="btn btn-primary w-50">Create Attribute</button>
