    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <div id="phoneNumbersList">
                @forelse($customer->phones as $existingPhone)
                    <div class="d-flex gap-2 mb-2 align-items-start phone-row">
                        <input type="hidden" name="phone_ids[]" value="{{ $existingPhone->id }}">
                        <div class="flex-grow-1">
                            <input type="text" name="phones[]" class="form-control phone-input" placeholder="Enter Phone Number" maxlength="10" inputmode="numeric" autocomplete="off" value="{{ $existingPhone->phone }}" />
                            <div class="invalid-feedback"></div>
                        </div>
                        @if($loop->first)
                ...
                @empty
                    <div class="d-flex gap-2 mb-2 align-items-start phone-row">
                        <input type="hidden" name="phone_ids[]" value="">
                        <div class="flex-grow-1">
        ...
        <div class="col-12">
            ...
            <input type="text" name="gst_no" class="form-control text-uppercase"
                placeholder="e.g. 24ABCDE1234F1Z5" value="{{ $customer->gst_no }}" maxlength="15" />
            <div class="invalid-feedback"></div>
        </div>
        <div class="col-12">
