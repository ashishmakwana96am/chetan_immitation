...
@section('page-css')
    ...
    <style>
        ...
        @media (min-width: 768px) {
            .contact-inquiry-filter-dropdown {
                min-width: 360px;
                width: 360px;
        ...
        @media (max-width: 767.98px) {
            #filterDropdownContainer .dropdown-menu.contact-inquiry-filter-dropdown {
            ...
            #filterDropdownContainer .dropdown-menu.contact-inquiry-filter-dropdown.show {
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="dropdown d-inline-block" id="filterDropdownContainer">
            ...
            <div class="dropdown-menu dropdown-menu-end shadow-lg contact-inquiry-filter-dropdown" id="filterDropdownMenu">
                ...
                <div class="filter-sidepanel-body">
                    <div class="mb-3 text-start">
                        ...
                        <div class="w-100">
                            <input type="text" id="filter-start-date" class="form-control flatpickr-inquiries mb-2" placeholder="Start Date" readonly style="width: 100% !important; display: block; margin-left: 0px !important;" />
                            <div class="text-center text-muted small mb-2">to</div>
                            <input type="text" id="filter-end-date" class="form-control flatpickr-inquiries" placeholder="End Date" readonly style="width: 100% !important; display: block; margin-left: 0px !important;" />
                        </div>
                    </div>
                </div>
...
@section('page-js')
    ...
    <script>
        $(document).ready(function () {
            ...
            function closeContactInquiryFilterSidepanel() {
                isForceClosing = true;
            ...
            $(document).on('click', '#btnCloseFilterDropdown, .filter-mobile-backdrop', function (e) {
                e.preventDefault();
                e.stopPropagation();
                closeContactInquiryFilterSidepanel();
            });
