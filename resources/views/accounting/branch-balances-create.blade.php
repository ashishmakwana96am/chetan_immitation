<div class="text-center mb-4">
    <h3 class="mb-2">Add Opening Balance</h3>
    <p class="text-muted">Credit or debit the cash / bank balance for a location</p>
</div>

<form id="commonModalForm" action="{{ route('admin.accounting.opening-balances.store') }}" method="POST" class="d-flex flex-column flex-grow-1">
    @csrf
    <div class="row g-3">
        <div class="col-12">
            <label class="form-label" for="entryLocation">Location <span class="text-danger">*</span></label>
            <select id="entryLocation" name="location_id" class="form-select">
